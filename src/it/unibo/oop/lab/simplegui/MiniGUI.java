...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JPanel canvasInner = new JPanel();
        canvas.setLayout(new BorderLayout());
        canvasInner.setLayout(new BoxLayout(canvasInner, BoxLayout.X_AXIS));
        final JButton write = new JButton("Print a random number on standard output");
        frame.setContentPane(canvas);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        final JLabel result = new JLabel("   Result :   ");
        final JLabel lb = new JLabel("Random Int  ");
        canvas.add(canvasInner, BorderLayout.CENTER);
        canvasInner.add(write, BorderLayout.CENTER);
        ...
        write.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                lb.setText(Integer.toString(randomInt));
